...
(function () {
	...
	var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function () {
		 ...
		 */
		var Drawing = function (doc, el, htOption) {
    		this._bIsPainted = false;
    		this._android = _getAndroid();
		
			this._htOption = htOption;
			this._elCanvas = doc.createElement("canvas");
			...
			this._bIsPainted = false;
			this._elImage = doc.createElement("img");
	 ...
	 */
	QRCode = function (doc, el, vOption) {
		this._htOption = {
			width : 256, 
			height : 256,
			typeNumber : 4,
		...
		this._el = el;
		this._oQRCode = null;
		this._oDrawing = new Drawing(doc, this._el, this._htOption);
