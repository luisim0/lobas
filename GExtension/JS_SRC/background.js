...
chrome.extension.onMessage.addListener(function(message, sender, sendResponse){
	if(message.action == 'get_php'){
		...
		switch(parseInt(message.code)){
			case 1:
				sendResponse({answer:"Hay un error en su cuenta: ¡No tiene clientes asignados! Por favor póngase en contacto con AS Find para solucionarlo"});
				break;
			case 2:
				sendResponse({answer:"El RFC no está registrado como usuario de AS Find"});
				break;
			case 3:
